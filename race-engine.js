...
var _RC_MAXJMP = 20;
var _RC_ROSTER = { claws:'d12',prod:'d12',jeff:'d12',bruce:'d12',kyros:'d12',hana:'d12', ace:'n12',sid:'n12',kaiji:'n12',vici:'n12',eric:'n12', ron:'d12',bob:'s1', san:'s2',bin:'s2', el:'s3',sil:'s3',miru:'s3',ditt:'s3' };   /* [v593] 'eric' aliased · [v594] hana n12→d12 (boss 7/9) · [v617] ron s1→d12 (boss 7/13: RON → Day 10, day-side group like PROD) · [v618] eric s2→n12 (boss 7/13: ERICSON → Night 10) */
...
function _rcScoreReports(reports, clients, settings, dqSet){
  ...
  reports.forEach(function(r){
    ...
    if(sess.target!=null && Number(sess.target)>0){
      ...
      // [v612] Friday Jumat-prayer allowance (lockstep with app): up to 2h of a gap overlapping
      // Fri 11:00–13:30 WIB is excused from the span before pro-rating.
